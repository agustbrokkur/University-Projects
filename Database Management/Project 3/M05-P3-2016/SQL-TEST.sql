...
-- ---------------------------------------------------------------------
select '4. Trigger on Bills' as now_checking;
...
-- ---------------------------------------------------------------------
select '5. Trigger on AccountRecords' as now_testing;
...
-- ---------------------------------------------------------------------
select '9. Function Transfer' as now_testing;
...
-- ---------------------------------------------------------------------
select '10. Function LoanMoney' as now_testing;
...
-- ---------------------------------------------------------------------
select '11. Function PayAllBills' as now_testing;

select 'This is simply an example of how it is used in practice!' as warning;
select 'You will need to test something like this MUCH more thoroughly!' as warning;

begin transaction;

-- here are 3 unpaid bills
SELECT * from bills where pid = 1;

-- execute the procedure
SELECT PayAllBills(1);
