...
public class ElevatorScene {
	...
	//public static Semaphore elevatorMusicMutex; //Person trying to get to their floor
	//public static Semaphore elevatorLeaveMutex;
	//public static Semaphore elevatorWaitMutex;
	public static Semaphore personCountMutex;
	public static Semaphore elevatorPeopleMutex; //Letting people in and out of the elevator
	//Semaphore for waiting to get off at a certain floor
	...
	private int peopleInElevator; //The amount of people inside of the elevator
	...
	public void restartScene(int numberOfFloors, int numberOfElevators) {
		...
		scene = this;
		//elevatorMusicMutex = new Semaphore(0);
		//elevatorLeaveMutex = new Semaphore(0);
		//elevatorWaitMutex = new Semaphore(0);
		...
		this.elevatorLeaveFloorMutex.clear();
		this.elevatorEnterFloorMutex.clear();
	...
	public void personExitsAtFloor(int floor) {
		...
		//System.out.println("Person Exited At Floor: " + floor);
	}
