...
public class BreadthFirstDirectedPaths {
    ...
    public static void main(String[] args) {
        ...
        StdOut.println(bfs.hasPathTo(0));
        StdOut.println(bfs.hasPathTo(1));
        StdOut.println(bfs.hasPathTo(2));
        StdOut.println(bfs.hasPathTo(3));
        StdOut.println(bfs.hasPathTo(4));
        StdOut.println(bfs.hasPathTo(5));
        StdOut.println(bfs.hasPathTo(6));
        StdOut.println(bfs.hasPathTo(7));
        StdOut.println(bfs.marked.length);
    }
