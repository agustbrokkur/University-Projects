...
{
    return state == 3 || state == 6 || state == 9;
}
...
int move(int state, char input)
{
    switch(state)
    {
        case 0:
            if(input == '.') return 2;
            else if(isdigit(input)) return 5;
            else if(input == 'E' || input == 'e') return 4;
            else if(input == '+' || input == '-') return 4;
            break;
        case 1:
            if(input == '.') return 4;
            else if(isdigit(input)) return 3;
            else if(input == 'E' || input == 'e') return 4;
        ...
        case 3:
            ...
            else if(input == 'E' || input == 'e') return 1;
            else if(input == '+' || input == '-') return 4;
            break;
        case 4:
            if(input == '.') return 4;
        ...
        case 5:
            if(input == '.') return 6;
            else if(isdigit(input)) return 8;
            else if(input == 'E' || input == 'e') return 7;
            else if(input == '+' || input == '-') return 4;
            break;
        case 6:
            if(input == '.') return 4;
        ...
        case 9:
            if(input == '.') return 4;
            else if(isdigit(input)) return 9;
            else if(input == 'E' || input == 'e') return 4;
            else if(input == '+' || input == '-') return 4;
            break;
    }
